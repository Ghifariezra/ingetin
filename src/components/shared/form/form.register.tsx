...
export default function RegisterForm() {
    ...
    return (
        <div className="relative min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-slate-50 dark:bg-slate-950 transition-colors duration-300 overflow-hidden">
            ...
            <PatternHero /> {/* Menggunakan Pattern yang sama dengan Hero */}

            {/* Blob Gradient di belakang Card */}
            ...
            <div className="relative w-full max-w-md space-y-8 animate-in fade-in zoom-in-95 duration-500">
                                    ...
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Input
                                                ...
                                                className="h-11 rounded-xl bg-slate-50 dark:bg-slate-950/50 border-slate-200 dark:border-slate-800 focus:ring-2 focus:ring-blue-500/20 transition-all"
                                                disabled={isLoading}
                                                {...field}
                                            />
                                        </FormControl>
                ...
                <p className="text-center text-sm text-slate-600 dark:text-slate-400">
                    ...
                    <Link
                        href="/auth/login"
                        className="font-semibold text-blue-600 hover:text-blue-500 dark:text-blue-400 dark:hover:text-blue-300 hover:underline transition-all"
                    >
                        {t("footer.link")}
                    </Link>
                </p>
